 ...
 * @dev A contract for receiving reputation tokens on the BSC Testnet using CCIP.
 */
contract ReputationReceiverBSC is ICCIPReceiver, ERC20, Pausable, ReentrancyGuard, Ownable {
